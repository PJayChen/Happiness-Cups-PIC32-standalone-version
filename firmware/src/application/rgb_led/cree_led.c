...
void LEDinit(void)
{
    ...
    PLIB_OC_Buffer16BitSet(APP_RGB_LED_RED_OC_ID, 0x01);
    PLIB_OC_Buffer16BitSet(APP_RGB_LED_GREEN_OC_ID, 0x01);
    PLIB_OC_Buffer16BitSet(APP_RGB_LED_BLUE_OC_ID, 0x01);
    /* Set pulse width(secondary compare) value */
    PLIB_OC_PulseWidth16BitSet(APP_RGB_LED_RED_OC_ID, 0x550);
    PLIB_OC_PulseWidth16BitSet(APP_RGB_LED_GREEN_OC_ID, 0x550);
    PLIB_OC_PulseWidth16BitSet(APP_RGB_LED_BLUE_OC_ID, 0x550);
    /* Enable Timer2. */
